...
import {
  addExpenseService,
  dailyTotalByCategoryService,
  dailyTotalExpenseService,
  deleteExpenseService,
  editExpenseService,
  getExpenseByIdService,
  getExpenseService,
  monthlyTotalByCategoryService,
  monthlyTotalExpenseService,
...
export const dailyTotalExpenseController = async (
  req: Request,
  res: Response,
): Promise<any> => {
  const date = new Date();
...
export const dailyTotalByCategoryController = async (
  req: Request,
  res: Response,
): Promise<any> => {
  const date = new Date();
  try {
    ...
    console.log(
      "Error in getting daily total expense by category" + " " + error,
    );
    return res.status(500).send({
      msg: "Internal server error",
    });
...
export const monthlyTotalByCategoryController = async (
  req: Request,
  res: Response,
): Promise<any> => {
  try {
    ...
    console.log(
      "Error in getting monthly total expense by category" + " " + error,
    );
    return res.status(500).send({
      msg: "Internal server error",
    });
...
export const monthlyTotalExpenseController = async (
  req: Request,
  res: Response,
): Promise<any> => {
  try {
